...
public class grade11 extends JFrame {
...
l3.setFont(Fteb1);
l3.setText(String.valueOf(grade11.generate(05,10)));
...
l5.setFont(Fteb2);
l5.setText(String.valueOf(grade11.generate(00,5)));
...
t1.addKeyListener(new KeyAdapter(){
  ...
  int ans = Integer.parseInt(t1.getText());
         if(tot==ans){
            ...
            l3.setText(String.valueOf(grade11.generate(05,10)));
            l5.setText(String.valueOf(grade11.generate(00,05)));
            t1.setText("");
...
System.out.println(String.valueOf(grade11.generate(00,10)));
