...
public class grade5 extends JFrame {
...
l3.setFont(Fteb1);
l3.setText(String.valueOf(grade5.generate(100,1500)));
...
l5.setFont(Fteb2);
l5.setText(String.valueOf(grade5.generate(100,1500)));
...
System.out.println(String.valueOf(grade5.generate(100,1500)));
