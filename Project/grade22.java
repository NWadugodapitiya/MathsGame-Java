...
public class grade22 extends JFrame {
...
l3.setFont(Fteb1);
l3.setText(String.valueOf(grade22.generate(32,50)));
...
l5.setFont(Fteb2);
l5.setText(String.valueOf(grade22.generate(00,32)));
...
System.out.println(String.valueOf(grade22.generate(11,50)));
