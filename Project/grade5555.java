...
public class grade5555 extends JFrame {
...
l3.setFont(Fteb1);
l3.setText(String.valueOf(grade5555.generate(10,100)));
...
l5.setFont(Fteb2);
l5.setText(String.valueOf(grade5555.generate(2,10)));
...
t1.addKeyListener(new KeyAdapter(){
  ...
  int mm = Integer.parseInt(l2.getText());      
         if(mm >= 150){
         Winmsg5555 Frame = new Winmsg5555();
         dispose();
         }
...
System.out.println(String.valueOf(grade5555.generate(1,100)));
