...
public class grade444 extends JFrame {
...
l3.setFont(Fteb1);
l3.setText(String.valueOf(grade444.generate(1,10)));
...
l5.setFont(Fteb2);
l5.setText(String.valueOf(grade444.generate(1,10)));
...
System.out.println(String.valueOf(grade444.generate(1,10)));
